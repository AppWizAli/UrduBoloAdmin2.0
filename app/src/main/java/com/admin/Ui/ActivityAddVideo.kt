...
/*
        ...
        binding.floatingAction.setOnClickListener {
           startActivity(Intent(mContext,ActivityVideoDetail::class.java))
    ...
    fun setAdapter() {
        ...
        binding.rvAddedVideos.layoutManager = LinearLayoutManager(mContext)
        binding.rvAddedVideos.adapter = AdapteraddVideo(mContext, list, this@ActivityAddVideo)
